...
class GATLayerImp3(GATLayer):
    ...
    def forward(self, data):
        ...
        score_per_edge = [(s,t), (s,t), (s,t), (s,t), ...]

        attention_per_edge = f(score_per_edge)

        node_with_weight = nodes * attention_per_edge

        out_nodes_features = aggregate_neighbors(node_with_weight, edge_index, in_nodes_features)
